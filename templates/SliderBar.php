...
<aside class="sidebar" id="sidebar">
  ...
  <ul class="sidebar__menu">
    ...
    <!--SIDEBAR MENU GESTION ACADEMICA-->
    ...
    <li class="menu-item has-submenu">
      ...
      <ul class="submenu">
        ...
        <li><a href="<?php echo BASE_URL; ?>/views/admin/MtMatterxTeacher.php?action=listarMATTERxTEACHER">Maestro
            Materias x Docente</a></li>
      </ul>
    </li>
    <!--SIDEBAR MENU NOTAS-->
    <li class="menu-item has-submenu">
      ...
      <ul class="submenu">
        ...
        <li><a href="<?php echo BASE_URL; ?>/views/matter/MatterxTeacher.php?action=listarMATTERxTEACHER">Materias
            Docente</a></li>
