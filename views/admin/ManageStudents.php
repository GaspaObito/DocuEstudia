...
<main class="ContainerGeneral">
  <div class="anotaciones">
    <h1 id="TitleStart">ESTUDIANTES <i class="fa-solid fa-user"></i></h1>
    <!-- ALERTAS -->
    <?php include(ROOT_PATH . "/templates/alerts.php"); ?>
    <form action="<?php echo BASE_URL; ?>/views/admin/ManageStudents.php" method="GET">
      <fieldset>
    ...
    <div class="alinear-boton">
      <a class="boton" href="<?php echo BASE_URL; ?>/views/forms/ManageStudent.php">
        <i class="fa-solid fa-plus"></i> AÑADIR ESTUDIANTE
      </a>
